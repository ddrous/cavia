...
def parse_args():
    ...
    parser.add_argument('--lr_inner', type=float, default=0.1, help='inner-loop learning rate (task-specific)')
    ...
    parser.add_argument('--num_hidden_layers', type=int, nargs='+', default=[176]*5)
